                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                           ...
                                           value="{{ session()->get('userName') }}" required autocomplete="name"
                                           autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                           ...
                                           value="{{ session()->get('userEmail') }}" required autocomplete="email">
                            ...
                            <input id="avatar" type="hidden" value="{{ session()->get('userAvatar') }}"
